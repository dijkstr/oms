package com.hundsun.boss.common.log;
...
public class Log4jManager {
    ...
    @ManagedOperationParameters({ @ManagedOperationParameter(name = "loggerName", description = "Logger name"), @ManagedOperationParameter(name = "newlevel", description = "New level") })
    ...
    /**
     * 根据log4j.properties中的定义, 设置项目默认的logger名称, 如com.hundsun.boss.
     */
