...
public class RSAUtil {
     ...
     * 存放用户rsa加密用队列
     */
    public static Map<String, KeyPair> keyPair = new HashMap<String, KeyPair>();
     ...
     * @return
     */
    public static KeyPair getPublicKey(String rsaSessionKey) {
        KeyPair newKeyPair = RSAUtil.generateKeyPair();
        keyPair.put(rsaSessionKey, newKeyPair);
        return newKeyPair;
    }

    /**
     * 16进制 To byte[] * @param hexString
     * 
     * @return byte[]
     */
     ...
     * @throws Exception
     */
    public static String decodeRSA(String rsaSessionKey, String value) {
        try {
            byte[] de_result = decrypt(keyPair.get(rsaSessionKey).getPrivate(), hexStringToBytes(value));
    ...
    public static void main(String[] args) throws Exception {
        ...
        getPublicKey("11");
        byte[] en_test = encrypt(keyPair.get("11").getPublic(), "8888".getBytes());
        byte[] de_test = decrypt(keyPair.get("11").getPrivate(), en_test);
        System.out.println(new String(de_test));
        RSAPublicKey publicKey = (RSAPublicKey) keyPair.get("11").getPublic();
        String modulus = publicKey.getModulus().toString();
        System.out.println(modulus);
        //公钥指数  
        String public_exponent = publicKey.getPublicExponent().toString();
        System.out.println(public_exponent);
        //System.out.println(decodeRSA("11", toHexString1(en_test)));
    }
}