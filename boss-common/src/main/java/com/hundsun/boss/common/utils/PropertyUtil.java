...
public class PropertyUtil {
	...
	//
	// Document dTemplate =
	// PropertyUtil.getDocumentByPath(PropertyUtil.readMailProperty("mailtemplatepath"),
	// mailConfig.getTemplate());
	// Mail mail = new Mail();
	...
	// * @throws Exception
	// */
	// public static List<ReportColumn> getReportColumns(String template) throws
	// Exception {
	// DocumentBuilder db =
	// DocumentBuilderFactory.newInstance().newDocumentBuilder();
	// URL url =
	// CommonUtil.class.getResource(PropertyUtil.readReportProperty("reporttemplatepath")
	// + template);
	// URLConnection urlConnection = url.openConnection();
	// InputStream inputStream = urlConnection.getInputStream();
	// Document doc = db.parse(inputStream);
