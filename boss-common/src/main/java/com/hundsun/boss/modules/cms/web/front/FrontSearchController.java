...
import com.hundsun.boss.modules.cms.entity.Guestbook;
import com.hundsun.boss.modules.cms.entity.Site;
import com.hundsun.boss.modules.cms.service.ArticleService;
import com.hundsun.boss.modules.cms.service.GuestbookService;
...
public class FrontSearchController extends BaseController {
    ...
    public String search(String t, @RequestParam(required = false) String q, @RequestParam(required = false) String qand, @RequestParam(required = false) String qnot, @RequestParam(required = false) String a, @RequestParam(required = false) String cid, @RequestParam(required = false) String bd, @RequestParam(required = false) String ed, HttpServletRequest request, HttpServletResponse response, Model model) {
