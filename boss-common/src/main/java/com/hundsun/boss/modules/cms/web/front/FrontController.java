package com.hundsun.boss.modules.cms.web.front;
...
import com.hundsun.boss.common.servlet.ValidateCodeServlet;
...
import com.hundsun.boss.modules.cms.entity.Comment;
import com.hundsun.boss.modules.cms.entity.Link;
import com.hundsun.boss.modules.cms.entity.Site;
import com.hundsun.boss.modules.cms.service.ArticleService;
import com.hundsun.boss.modules.cms.service.CategoryService;
import com.hundsun.boss.modules.cms.service.CommentService;
import com.hundsun.boss.modules.cms.service.LinkService;
import com.hundsun.boss.modules.cms.utils.CmsUtils;
...
public class FrontController extends BaseController {
    ...
    public String listCustom(@PathVariable String categoryId, @PathVariable String customView, @RequestParam(required = false, defaultValue = "1") Integer pageNo, @RequestParam(required = false, defaultValue = "15") Integer pageSize, Model model) {
        Category category = categoryService.get(categoryId);
        if (category == null) {
            Site site = CmsUtils.getSite(Site.defaultSiteId());
            model.addAttribute("site", site);
            ...
            if (ValidateCodeServlet.validate(request, validateCode)) {
                if (StringUtils.isNotBlank(replyId)) {
                    ...
                    if (replyComment != null) {
                        comment.setContent("<div class=\"reply\">" + replyComment.getName() + ":<br/>" + replyComment.getContent() + "</div>" + comment.getContent());
                    }
                }
