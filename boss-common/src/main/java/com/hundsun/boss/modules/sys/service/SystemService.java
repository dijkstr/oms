...
import com.hundsun.boss.common.security.Digests;
import com.hundsun.boss.common.utils.Collections3;
import com.hundsun.boss.common.utils.Encodes;
import com.hundsun.boss.common.utils.StringUtils;
import com.hundsun.boss.modules.sys.dao.MenuDao;
import com.hundsun.boss.modules.sys.dao.RoleDao;
import com.hundsun.boss.modules.sys.dao.UserDao;
...
import com.hundsun.boss.modules.sys.security.SystemAuthorizingRealm;
...
public class SystemService extends BaseService {
    ...
    public Page<User> findUser(Page<User> page, User user) {
        ...
        if (user.getOffice() != null && StringUtils.isNotBlank(user.getOffice().getId())) {
            dc.add(Restrictions.or(Restrictions.eq("office.id", user.getOffice().getId()), Restrictions.like("office.parentIds", "%," + user.getOffice().getId() + ",%")));
        }
    ...
    public List<User> findUsersByOffice(String office_id) {
        return userDao.findUsersByOffice(office_id);
    }
