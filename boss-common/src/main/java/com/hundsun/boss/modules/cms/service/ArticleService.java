package com.hundsun.boss.modules.cms.service;
...
import com.hundsun.boss.modules.cms.dao.ArticleDao;
import com.hundsun.boss.modules.cms.dao.CategoryDao;
...
public class ArticleService extends BaseService {
    ...
    public Page<Article> find(Page<Article> page, Article article, boolean isDataScopeFilter) {
        ...
        if (article.getCategory() != null && StringUtils.isNotBlank(article.getCategory().getId()) && !Category.isRoot(article.getCategory().getId())) {
            ...
            if (category != null) {
                dc.add(Restrictions.or(Restrictions.eq("category.id", category.getId()), Restrictions.like("category.parentIds", "%," + category.getId() + ",%")));
    ...
    public void save(Article article) {
        ...
        article.setUpdateDate(DateUtils.formatDate(new Date()));
    ...
    public Page<Article> search(Page<Article> page, String q, String categoryId, String beginDate, String endDate) {
        ...
        if (StringUtils.isNotBlank(beginDate) && StringUtils.isNotBlank(endDate)) {
            bcList.add(new BooleanClause(new TermRangeQuery("updateDate", beginDate.replaceAll("-", ""), endDate.replaceAll("-", ""), true, true), Occur.MUST));
        }
