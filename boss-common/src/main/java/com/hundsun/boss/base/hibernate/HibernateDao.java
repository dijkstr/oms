...
import com.hundsun.boss.common.utils.Reflections;
...
public class HibernateDao<T> {
    ...
    private Logger logger = Logger.getLogger(HibernateDao.class);
    ...
    public int deleteById(Serializable id) {
        ...
        return update("delete " + entityClass.getSimpleName() + " where " + CommonUtil.getIdFiled(entityClass) + " = :p1", new Parameter(id));
    ...
    public int deleteById(Serializable id, String likeParentIds) {
        ...
        //return update("update " + entityClass.getSimpleName() + " set delFlag = '" + BaseEntity.DEL_FLAG_DELETE + "' where id = :p1 or parentIds like :p2", new Parameter(id, likeParentIds));
    }
