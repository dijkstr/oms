...
public class OrderPriceForm extends BaseForm {
    ...
    private String step_begin_val;

    private String step_end_val;
    ...
    public String getStep_begin_val() {
        return step_begin_val;
    }

    public void setStep_begin_val(String step_begin_val) {
        this.step_begin_val = step_begin_val;
    }

    public String getStep_end_val() {
        return step_end_val;
    }

    public void setStep_end_val(String step_end_val) {
        this.step_end_val = step_end_val;
    }
