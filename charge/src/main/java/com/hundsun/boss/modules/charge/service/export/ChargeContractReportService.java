...
@Service("chargeContractReportService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class ChargeContractReportService extends ApplicationObjectSupport implements IReportService {
    ...
    public Map getData(ReportConfig reportConfig, DownloadForm downloadForm) throws Exception {
        ...
        try {
            ...
            mValues.put("griddata", chargeBillService.queryBillChargingList(downloadForm));
        } catch (Exception e) {
            throw e;
        }
        return mValues;
