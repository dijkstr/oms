 ...
 *
 */
public class OrderIncomeSetting {
    /**
     * 主键id
     */
    private String id;
     ...
     * 收入设置列表.
     */
    private List<OrderIncomeSetting> listOrderIncomeSetting;
    ...
    public List<OrderIncomeSetting> getListOrderIncomeSetting() {
        return listOrderIncomeSetting;
    }

    public void setListOrderIncomeSetting(List<OrderIncomeSetting> listOrderIncomeSetting) {
