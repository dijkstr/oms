...
@Service("unifyDataReportService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class UnifyDataReportService extends ApplicationObjectSupport implements IReportService {
    ...
    public Map getData(ReportConfig reportConfig, DownloadForm downloadForm) throws Exception {
        ...
        try {
            ...
            ChargeUnifyInterface req = new ChargeUnifyInterface();
            BeanUtils.copyProperties(downloadForm, req);
            List<Map> list = chargeUnifyInterfaceService.exportUnifyDataList(req);
