...
@Service("finContractReportService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class FinContractReportService extends ApplicationObjectSupport implements IReportService {
    ...
    public Map getData(ReportConfig reportConfig, DownloadForm downloadForm) throws Exception {
        ...
        try {
            ...
            List<Map> finSummaryList = finSummaryService.exportContractDetailList(req);
