...
@Service("finBUReportService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class FinBUReportService extends ApplicationObjectSupport implements IReportService {
    ...
    public Map getData(ReportConfig reportConfig, DownloadForm downloadForm) throws Exception {
        ...
        try {
            ...
            mValues.put("griddata", finSummaryService.exportBUDetailList(req));
        } catch (Exception e) {
            throw e;
        }
        return mValues;
