...
public class FinSummaryReportService extends ApplicationObjectSupport implements IReportService {
    ...
    public Map getData(ReportConfig reportConfig, DownloadForm downloadForm) throws Exception {
        ...
        try {
            ...
            List<Map> finSummaryList = finSummaryService.exportFinanceDetailList(req);
