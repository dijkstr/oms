...
@Service("incomeSettingService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class IncomeSettingReportService extends ApplicationObjectSupport implements IReportService {
    ...
    public Map getData(ReportConfig reportConfig, DownloadForm downloadForm) throws Exception {
        ...
        try {
            ...
            List<Map> list = orderInfoService.queryIncomeSettingList(req);
            for(Map map : list) {
